<template>
    <div>
        ...
        <div v-if="page.body" class="fix-width fix-width-mobile p-t-80">
            ...
            <div v-if="attachments.length && !aboutPage">
        ...
        <template v-if="page.options">
            <row-blocks v-if="page.options.show_blocks && blocks.length" :blocks="blocks"></row-blocks>
            <row-articles v-if="page.options.show_latest_articles && articles.length" :articles="articles"></row-articles>
        </template>
    </div>
</template>
