      ...
      <div class="row">
        <div class="col-12 col-sm-6">
          ...
          <div class="form-group">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="block_type" id="program" v-model="blockForm.block_type" value="program">
              <label class="form-check-label" for="program">
                Program
              </label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="block_type" id="feature" v-model="blockForm.block_type" value="feature">
        ...
        <div class="col-12 col-sm-6">
          ...
          <div class="form-group">
            ...
            <upload-image id="block_image" :button-text="trans('frontend.choose_featured_image')" upload-path="/frontend/block/featured/image"
                          remove-path="/frontend/block/featured/image" :image-source="blockForm.featured_image" @uploaded="updateImage"
                          @removed="blockForm.featured_image = ''"></upload-image>
    ...
    get() {
      ...
      axios.get('/api/frontend/block/' + this.uuid)
          .then(response => {
            ...
            this.blockForm.block_type = response.block.block_type;
