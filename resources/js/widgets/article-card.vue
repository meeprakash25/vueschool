        ...
        <div class="card-body">
            <header>
                ...
                <div class="article-meta">
                    <small class="type text-muted"><i class="fas fa-hashtag"></i> {{ article.article_type.name === 'Circular' ? 'Notice' : article.article_type.name}}</small>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="cta text-right">
                            <button type="button" class="btn btn-danger">{{trans('general.read_more')}}</button>
                        </div>
                    </div>
                </div>
            </footer>
