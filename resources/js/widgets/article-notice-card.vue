        ...
        <div class="card-body">
            <div class="event-info">
                <div class="event-schedule pull-left">
                    <span class="day">{{article.date_of_article | momentCustomGetDOM}}</span>
                    <span class="month">{{article.date_of_article | momentCustomGetMOY}}</span>
                </div>
                <p>
                    <span class="event-title">{{article.title}}</span>
                    <span class="meta-data text-muted">
                        <small class="type">{{article.article_type.name}}</small>
                      <small class="date"><i class="far fa-clock"></i> {{article.date_of_article | moment}}</small>
                    </span>
                </p>
            </div>
        </div>
