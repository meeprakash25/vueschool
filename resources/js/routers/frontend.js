export default [
    ...
    {
        path: '/notices',
        component: () => import(/* webpackChunkName: "js/pages/themes/events" */ '@views/pages/themes/default/notices')
    },
    {
        path: '/results',
        component: () => import(/* webpackChunkName: "js/pages/themes/events" */ '@views/pages/themes/default/results')
    },
    {
        path: '/calendar',
