...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/academic/timetable/allocation.vue?vue&type=template&id=08137327&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/academic/timetable/allocation.vue?vue&type=template&id=08137327& ***!
  \***************************************************************************************************************************************************************************************************************************/
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12 col-sm-6" }, [
          _c("h3", { staticClass: "text-themecolor" }, [
            _vm._v(_vm._s(_vm.trans("academic.timetable_allocation")) + " "),
            _vm.timetable.batch
              ? _c("span", [
                  _vm._v(" - "),
                  _c("small", [
                    _vm._v(
                      _vm._s(
                        _vm.timetable.batch.course.name +
                          " " +
                          _vm.timetable.batch.name
                      ) +
                        " " +
                        _vm._s(_vm.trans("general.from")) +
                        " " +
                        _vm._s(_vm._f("moment")(_vm.timetable.date_effective))
                    )
                  ])
                ])
              : _vm._e()
        ...
        _c("div", { staticClass: "card-body" }, [
          _vm.timetable
            ? _c(
                "form",
                {
                  on: {
                    ...
                    keydown: function($event) {
                      return _vm.timetableAllocationForm.errors.clear(
                        $event.target.name
                      )
                    }
                  }
                ...
                [
                  _vm._l(_vm.timetableAllocationForm.days, function(
                    day,
                    index
                  ) {
                    return _c("div", { staticClass: "row" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "col-12 col-sm-11" }, [
                        day.sessions.length
                          ? _c(
                              "div",
                              { staticClass: "row" },
                                    ...
                                    _c("small", [
                                      _vm._v(
                                        _vm._s(session.name) +
                                          " (" +
                                          _vm._s(
                                            _vm.getSessionStartTime(session) +
                                              " " +
                                              _vm.trans("general.to") +
                                              " " +
                                              _vm.getSessionEndTime(session)
                                          ) +
                                          ")"
                                      )
                                    ]),
          ...
          _vm.subjects.length
            ? _c("div", { staticClass: "table-responsive" }, [
                _c("table", { staticClass: "table table-sm" }, [
                  _c("thead", [
                    _c("tr", [
                      _c("th", [_vm._v(_vm._s(_vm.trans("academic.subject")))]),
                      _vm._v(" "),
                      _c("th", [
                      ...
                      _c("th", [
                        _vm._v(
                          _vm._s(
                            _vm.trans("academic.subject_max_class_per_week")
                          )
                        )
                      ]),
                      _vm._v(" "),
                      _c("th", [
                        _vm._v(
                          _vm._s(
                            _vm.trans("academic.subject_alloted_class_per_week")
                          )
                        )
                      ])
                    ])
                  ...
                  _c(
                    ...
                    _vm._l(_vm.subjects, function(subject) {
                      return _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(_vm.getSubjectTeacher(subject)))
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(subject.max_class_per_week))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(_vm.getSubjectCount(subject)))])
                      ])
                    }),
                    0
                  ),
                  ...
                  _c("tfoot", [
                    _c("tr", [
                      ...
                      _c("td"),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(_vm.getTotalCount()))])
                    ])
                  ])
                ])
              ])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_allocation_vue_vue_type_template_id_08137327___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./allocation.vue?vue&type=template&id=08137327& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/academic/timetable/allocation.vue?vue&type=template&id=08137327&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_allocation_vue_vue_type_template_id_08137327___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_allocation_vue_vue_type_template_id_08137327___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=allocation.js.map?id=f3089f4c5735c5be998b