(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/dashboard~js/pages/themes/calendar~js/pages/themes/events~js/pages/themes/home~js/pages/themes/pa~afad2bb8"],{
  ...
  methods: {
    get: function get() {
      ...
      axios.get(articleUrl).then(function (response) {
        ...
        _this.attachments = response.attachments; // console.log(this.attachments[0]);
                  ...
                  _vm._t("header", [
                    ...
                    _c(
                      "ShareNetwork",
                      {
                        ...
                        attrs: {
                          network: "facebook",
                          url: "http://tdtc.edu.np/notices",
                          title: _vm.article.title,
                          description: "",
                          quote: _vm.article.title,
                          hashtags: "ImportantNotice"
                        }
                      },
                      [
                        _c("i", { staticClass: "fab fah fa-lg fa-facebook" }),
                        _vm._v(" "),
                        _c("span", [_vm._v("Share on Facebook")])
                      ]
                    ),
                    _vm._v(" "),
                    _c(
...
//# sourceMappingURL=pa~afad2bb8.js.map?id=f6269a5ebf5a807aee00