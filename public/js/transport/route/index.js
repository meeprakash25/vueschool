...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/transport/route/index.vue?vue&type=template&id=3bf69537&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/transport/route/index.vue?vue&type=template&id=3bf69537& ***!
  \*******************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c("h3", { staticClass: "text-themecolor" }, [
              _vm._v(
                _vm._s(_vm.trans("transport.route")) + " \n                    "
              ),
              _vm.transport_routes.total
                ? _c(
                    "span",
          ...
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c(
              ...
              [
                _vm.hasPermission("assign-transport-route")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      [
                        ...
                        _c("span", { staticClass: "d-none d-sm-inline" }, [
                          _vm._v(_vm._s(_vm.trans("transport.assign_route")))
                        ])
                      ]
                    )
                  : _vm._e(),
                ...
                _vm.transport_routes.total &&
                !_vm.showCreatePanel &&
                _vm.hasPermission("create-transport-route")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("span", { staticClass: "d-none d-sm-inline" }, [
                          _vm._v(_vm._s(_vm.trans("transport.add_new_route")))
                        ])
                      ]
                    )
                  : _vm._e(),
                ...
                _c("div", { staticClass: "btn-group" }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.hasPermission("list-transport-stoppage")
                        ? _c(
                            "button",
                            {
                              staticClass: "dropdown-item custom-dropdown",
                            ...
                            [
                              _c("i", { staticClass: "fas fa-stoppage-notch" }),
                              _vm._v(
                                " " +
                                  _vm._s(
                                    _vm.trans("transport.transport_stoppage")
                                  )
                              )
                            ]
                          )
                    ...
                    _c("div", { staticClass: "card-footer text-right" }, [
                      ...
                      _c(
                        "button",
                        {
                          ...
                          attrs: { type: "button" },
                          on: { click: _vm.getTransportRoutes }
                        },
                        [_vm._v(_vm._s(_vm.trans("general.filter")))]
                      )
                    ])
                      ...
                      _c("table", { staticClass: "table table-sm" }, [
                        _c("thead", [
                          _c("tr", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(_vm.trans("transport.route_description"))
                              )
                            ]),
                            _vm._v(" "),
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.transport_routes.data, function(
                            transport_route
                          ) {
                            return _c("tr", [
                              _c("td", {
                              ...
                              _c("td", [
                                _c(
                                  ...
                                  _vm._l(
                                    transport_route.transport_route_details,
                                    function(transport_route_detail) {
                                      return _c("li", [
                                        _vm._v(
                                          _vm._s(
                                            transport_route_detail
                                              .transport_stoppage.name
                                          )
                                        )
                                      ])
                                    }
                              ...
                              _c("td", { staticClass: "table-option" }, [
                                _c("div", { staticClass: "btn-group" }, [
                                  transport_route.transport_route_details
                                        ...
                                        "button",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              ...
                                              return _vm.showStoppageReorderAction(
                                                transport_route
                                              )
                                            }
                                          }
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.hasPermission("edit-transport-route")
                                    ? _c(
                                        "button",
                                        {
                                          directives: [
                                            {
                                              ...
                                              rawName: "v-tooltip",
                                              value: _vm.trans(
                                                "transport.edit_route"
                                              ),
                                              expression:
                                                "trans('transport.edit_route')"
                                            }
                                          ],
                                          staticClass: "btn btn-info btn-sm",
                                          on: {
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.hasPermission("delete-transport-route")
                                    ? _c(
                                        "button",
                                        {
                                          directives: [
                                            {
                                              ...
                                              expression:
                                                "{ok: confirmDelete(transport_route)}"
                                            },
                                            {
                                              name: "tooltip",
                                              rawName: "v-tooltip",
      ...
      _vm._v(" "),
      _vm.hasPermission("edit-transport-route") && _vm.showStoppageReorderModal
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_3bf69537___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=3bf69537& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/transport/route/index.vue?vue&type=template&id=3bf69537&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_3bf69537___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_3bf69537___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=index.js.map?id=60dc5fc8dbbd77d27756