...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/transport/vehicle/fuel/index.vue?vue&type=template&id=6bdc8421&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/transport/vehicle/fuel/index.vue?vue&type=template&id=6bdc8421& ***!
  \**************************************************************************************************************************************************************************************************************************/
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c("h3", { staticClass: "text-themecolor" }, [
              _vm._v(
                _vm._s(_vm.trans("transport.vehicle_fuel")) +
                  " \n                    "
              ),
              _vm.vehicle_fuels.total
                ? _c(
                    "span",
          ...
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c(
              ...
              [
                _vm.vehicle_fuels.total &&
                !_vm.showCreatePanel &&
                _vm.hasPermission("create-vehicle-fuel")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      [
                        ...
                        _c("span", { staticClass: "d-none d-sm-inline" }, [
                          _vm._v(
                            _vm._s(_vm.trans("transport.add_new_vehicle_fuel"))
                          )
                        ])
                      ]
                    )
                            ...
                            _c(
                              "v-select",
                              {
                                attrs: {
                                  ...
                                  placeholder: _vm.trans(
                                    "transport.select_vehicle_fuel_type"
                                  ),
                                  multiple: true,
                                  "close-on-select": false,
                                  "clear-on-select": false,
                      ...
                      _c(
                        ...
                        [
                          _c("date-range-picker", {
                            attrs: {
                              "start-date":
                                _vm.filter.date_of_fueling_start_date,
                              "end-date": _vm.filter.date_of_fueling_end_date,
                              label: _vm.trans(
                                "transport.date_of_fueling_between"
                              )
                            },
                            on: {
                      ...
                      _c(
                        ...
                        [
                          _c("h4", { staticClass: "card-title" }, [
                            _vm._v(
                              _vm._s(
                                _vm.trans("transport.add_new_vehicle_fuel")
                              )
                            )
                          ]),
                          _vm._v(" "),
                ...
                _vm.vehicle_fuels.total
                  ? _c("div", { staticClass: "table-responsive" }, [
                      _c("table", { staticClass: "table table-sm" }, [
                        _c("thead", [
                          _c("tr", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("transport.vehicle_fuel_quantity")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(_vm.trans("transport.date_of_fueling"))
                              )
                            ]),
                            _vm._v(" "),
                            _c("th", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans(
                                    "transport.vehicle_fuel_description"
                                  )
                                )
                              )
                            ]),
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.vehicle_fuels.data, function(
                            vehicle_fuel
                          ) {
                            return _c("tr", [
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    vehicle_fuel.vehicle.name +
                                      " (" +
                                      vehicle_fuel.vehicle.registration_number +
                                      ")"
                                  )
                                )
                              ]),
                              ...
                              _c("td", [
                                _vm._v(
                                  _vm._s(vehicle_fuel.vehicle_fuel_type.name)
                                )
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm.formatNumber(
                                      vehicle_fuel.quantity,
                                      _vm.getConfig(
                                        "vehicle_fuel_quantity_decimal_place"
                                      )
                                    )
                                  )
                                )
                              ...
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(vehicle_fuel.description))
                              ]),
                              _vm._v(" "),
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: "v-tooltip",
                                          value: _vm.trans(
                                            "transport.view_vehicle_fuel"
                                          ),
                                          expression:
                                            "trans('transport.view_vehicle_fuel')"
                                        }
                                      ],
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: "v-tooltip",
                                          value: _vm.trans(
                                            "transport.edit_vehicle_fuel"
                                          ),
                                          expression:
                                            "trans('transport.edit_vehicle_fuel')"
                                        }
                                      ],
                                      staticClass: "btn btn-info btn-sm",
                                      on: {
                                      ...
                                      directives: [
                                        {
                                          ...
                                          expression:
                                            "{ok: confirmDelete(vehicle_fuel)}"
                                        },
                                        {
                                          name: "tooltip",
                                          rawName: "v-tooltip",
                                          value: _vm.trans(
                                            "transport.delete_vehicle_fuel"
                                          ),
                                          expression:
                                            "trans('transport.delete_vehicle_fuel')"
                                        }
                                      ],
                                      key: vehicle_fuel.id,
                        ...
                        _c("tfoot", [
                          _c("tr", [
                            ...
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm.formatCurrency(_vm.average_price_per_unit)
                                ) + " "
                              ),
                              _c("small", [
                                _vm._v(
                                  "(" +
                                    _vm._s(_vm.trans("general.average")) +
                                    ")"
                                )
                              ])
                            ]),
                            ...
                            _c("td", [
                              _vm._v(
                                _vm._s(_vm.formatCurrency(_vm.total_price))
                              )
                            ]),
                            _vm._v(" "),
              ...
              _c("div", { staticClass: "modal-wrapper" }, [
                _c("div", { staticClass: "modal-container modal-lg" }, [
                  _c(
                    ...
                    [
                      _vm._t("header", [
                        _vm.vehicle_fuel.vehicle
                          ? _c("span", [
                              _vm._v(
                                _vm._s(
                                  _vm.vehicle_fuel.vehicle.name +
                                    " (" +
                                    _vm.vehicle_fuel.vehicle
                                      .registration_number +
                                    ")"
                  ...
                  _c(
                    ...
                    [
                      _vm._t("body", [
                        _vm.vehicle_fuel.vehicle_fuel_type
                          ? _c("h4", { staticClass: "card-title" }, [
                              _vm._v(
                                _vm._s(
                                  _vm.vehicle_fuel.vehicle_fuel_type.name
                                ) +
                                  " (" +
                                  _vm._s(
                                    _vm.formatNumber(
                                      _vm.vehicle_fuel.quantity,
                                      _vm.getConfig(
                                        "vehicle_fuel_quantity_decimal_place"
                                      )
                                    )
                                  ...
                                  _vm._s(
                                    _vm.formatCurrency(
                                      _vm.vehicle_fuel.price_per_unit
                                    ) +
                                      " " +
                                      _vm.trans(
                                        "transport.vehicle_fuel_price_per_unit"
                        ...
                        _c("div", [
                          _vm._v(
                            "\n                                " +
                              ...
                              _vm._s(
                                _vm._f("moment")(
                                  _vm.vehicle_fuel.date_of_fueling
                                )
                              ) +
                              "\n                            "
                          )
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6bdc8421___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=6bdc8421& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/transport/vehicle/fuel/index.vue?vue&type=template&id=6bdc8421&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6bdc8421___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_6bdc8421___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=index.js.map?id=61871c64bdac89b680db