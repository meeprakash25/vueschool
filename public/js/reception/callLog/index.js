...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/reception/call-log/index.vue?vue&type=template&id=bc352252&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/reception/call-log/index.vue?vue&type=template&id=bc352252& ***!
  \**********************************************************************************************************************************************************************************************************************/
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c("h3", { staticClass: "text-themecolor" }, [
              _vm._v(
                _vm._s(_vm.trans("reception.call_log")) +
                  " \n                    "
              ),
              _vm.call_logs.total
                ? _c(
          ...
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c(
              ...
              [
                _vm.call_logs.total &&
                !_vm.showCreatePanel &&
                _vm.hasPermission("create-call-log")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      [
                        ...
                        _c("span", { staticClass: "d-none d-sm-inline" }, [
                          _vm._v(
                            _vm._s(_vm.trans("reception.add_new_call_log"))
                          )
                        ])
                      ]
                    )
                              ...
                              "v-select",
                              {
                                attrs: {
                                  ...
                                  placeholder: _vm.trans(
                                    "reception.select_calling_purpose"
                                  ),
                                  multiple: true,
                      ...
                      _c("table", { staticClass: "table table-sm" }, [
                        _c("thead", [
                          _c("tr", [
                            ...
                            _vm._v(" "),
                            _c("th", [
                              _vm._v(_vm._s(_vm.trans("reception.call_detail")))
                            ]),
                            _vm._v(" "),
                            _c("th", [
                              _vm._v(
                                _vm._s(_vm.trans("reception.call_log_name"))
                              )
                            ]),
                            _vm._v(" "),
                            _c("th", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(_vm.trans("reception.call_duration"))
                              )
                            ]),
                            _vm._v(" "),
                            _c("th", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("reception.call_log_description")
                                )
                              )
                            ]),
                            _vm._v(" "),
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.call_logs.data, function(call_log) {
                            return _c("tr", [
                              _c("td", {
                                domProps: { textContent: _vm._s(call_log.id) }
                              }),
                              _vm._v(" "),
                              _c("td", {
                                domProps: {
                                  textContent: _vm._s(
                                    call_log.calling_purpose.name
                                  )
                                }
                              }),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  "\n                                    " +
                                    _vm._s(call_log.outgoing_number) +
                                    " " +
                                    _vm._s(_vm.trans("general.to")) +
                                    " " +
                                    _vm._s(call_log.incoming_number) +
                                    "\n                                "
                                )
                              ]),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(call_log.name))]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(_vm._f("moment")(call_log.date)))
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("momentTime")(call_log.start_time)
                                  )
                                )
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("momentTime")(call_log.end_time)
                                  )
                                )
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(call_log.call_duration))
                              ]),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(call_log.description))]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm.getEmployeeName(call_log.user.employee)
                                  ) + " "
                                ),
                                _c("br"),
                                _vm._v(
                              ...
                              _c("td", { staticClass: "table-option" }, [
                                _c("div", { staticClass: "btn-group" }, [
                                  _vm.hasPermission("edit-call-log")
                                    ? _c(
                                        "button",
                                        {
                                          directives: [
                                            {
                                              ...
                                              rawName: "v-tooltip",
                                              value: _vm.trans(
                                                "reception.edit_call_log"
                                              ),
                                              expression:
                                                "trans('reception.edit_call_log')"
                                            }
                                          ],
                                          staticClass: "btn btn-info btn-sm",
                                          on: {
                                    ...
                                    : _vm._e(),
                                  _vm._v(" "),
                                  _vm.hasPermission("delete-call-log")
                                    ? _c(
                                        "button",
                                        {
                                          directives: [
                                            {
                                              ...
                                              expression:
                                                "{ok: confirmDelete(call_log)}"
                                            },
                                            {
                                              name: "tooltip",
                                              rawName: "v-tooltip",
                                              value: _vm.trans(
                                                "reception.delete_call_log"
                                              ),
                                              expression:
                                                "trans('reception.delete_call_log')"
                                            }
                                          ],
                                          key: call_log.id,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_bc352252___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=bc352252& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/reception/call-log/index.vue?vue&type=template&id=bc352252&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_bc352252___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_bc352252___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=index.js.map?id=ec13d3bbd0118cfcb220