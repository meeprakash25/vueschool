...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/finance/fee/allocation/index.vue?vue&type=template&id=f2751140&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/finance/fee/allocation/index.vue?vue&type=template&id=f2751140& ***!
  \**************************************************************************************************************************************************************************************************************************/
        ...
        _c("div", { staticClass: "row" }, [
          ...
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c(
              ...
              [
                _vm.fee_allocations.total &&
                _vm.hasPermission("create-fee-allocation")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      [
                        ...
                        _c("span", { staticClass: "d-none d-sm-inline" }, [
                          _vm._v(
                            _vm._s(_vm.trans("finance.add_new_fee_allocation"))
                          )
                        ])
                      ]
                    )
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm.hasPermission("list-fee-group")
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.hasPermission("list-fee-head")
                        ? _c(
                            "button",
                            {
                              staticClass: "dropdown-item custom-dropdown",
                    ...
                    _c("div", { staticClass: "card-footer text-right" }, [
                      ...
                      _c(
                        "button",
                        {
                          ...
                          attrs: { type: "button" },
                          on: { click: _vm.getFeeAllocations }
                        },
                        [_vm._v(_vm._s(_vm.trans("general.filter")))]
                      )
                    ])
                ...
                _vm.fee_allocations.total
                  ? _c("div", { staticClass: "table-responsive" }, [
                      _c("table", { staticClass: "table table-sm" }, [
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.fee_allocations.data, function(
                            fee_allocation
                          ) {
                            return _c("tr", [
                              _c("td", [
                                fee_allocation.course_id
                                  ? _c("span", [
                                      _vm._v(_vm._s(fee_allocation.course.name))
                                    ])
                                  : _c("span", [
                                      _vm._v(
                                        _vm._s(
                                          fee_allocation.batch.course.name +
                                            " " +
                                            fee_allocation.batch.name
                                        )
                                      )
                                    ])
                              ]),
                              ...
                              _c("td", [
                                _c(
                                  ...
                                  _vm._l(
                                    fee_allocation.fee_allocation_groups,
                                      ...
                                      directives: [
                                        {
                                          ...
                                          expression:
                                            "trans('finance.view_fee_allocation')"
                                        }
                                      ],
                                      staticClass: "btn btn-info btn-sm",
                                      on: {
                                                    ...
                                                    directives: [
                                                      {
                                                        ...
                                                        rawName: "v-tooltip",
                                                        value: _vm.trans(
                                                          "finance.edit_fee_allocation"
                                                        ),
                                                        expression:
                                                          "trans('finance.edit_fee_allocation')"
                                                      }
                                                    ],
                                                    staticClass:
                                                    ...
                                                    directives: [
                                                      {
                                                        ...
                                                        rawName: "v-tooltip",
                                                        value: _vm.trans(
                                                          "finance.copy_batch_fee_allocation"
                                                        ),
                                                        expression:
                                                          "trans('finance.copy_batch_fee_allocation')"
                                                      },
                                                      {
                                                        name: "confirm",
                                                        rawName: "v-confirm",
                                                    ...
                                                    directives: [
                                                      {
                                                        ...
                                                        expression:
                                                          "{ok: confirmDelete(fee_allocation)}"
                                                      },
                                                      {
                                                        name: "tooltip",
                                                        rawName: "v-tooltip",
                                                        value: _vm.trans(
                                                          "finance.delete_fee_allocation"
                                                        ),
                                                        expression:
                                                          "trans('finance.delete_fee_allocation')"
                                                      }
                                                    ],
                                                    key:
                                                      "delete_" +
                                              ...
                                              directives: [
                                                {
                                                  ...
                                                  rawName: "v-tooltip",
                                                  value: _vm.trans(
                                                    "finance.duplicate_fee_allocation"
                                                  ),
                                                  expression:
                                                    "trans('finance.duplicate_fee_allocation')"
                                                }
                                              ],
                                              staticClass:
                                                "dropdown-item custom-dropdown-menu",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f2751140___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=f2751140& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/finance/fee/allocation/index.vue?vue&type=template&id=f2751140&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f2751140___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_f2751140___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=index.js.map?id=6e0d46b09c0fe15d846b