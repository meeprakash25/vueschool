...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/employee/leave/request/show.vue?vue&type=template&id=46b23aa7&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/employee/leave/request/show.vue?vue&type=template&id=46b23aa7& ***!
  \*************************************************************************************************************************************************************************************************************************/
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12 col-sm-6" }, [
          _c("h3", { staticClass: "text-themecolor" }, [
            _vm._v(
              _vm._s(
                _vm.trans("employee.leave_request") +
                  " #" +
                  _vm.leave_request.id
              ) + "\n                        "
            ),
            _vm.leave_request.employee
              ? _c(
                  "span",
                  ...
                  [
                    _vm._v(
                      "(" +
                        _vm._s(
                          _vm.getEmployeeName(_vm.leave_request.employee)
                        ) +
                        ") "
                    )
                  ]
              ...
              _c("div", { staticClass: "card border-right" }, [
                _c("div", { staticClass: "card-body" }, [
                  _c("h4", { staticClass: "card-title m-3" }, [
                    _vm._v(_vm._s(_vm.trans("employee.leave_request_detail")))
                  ]),
                  _vm._v(" "),
                        ...
                        _c("tbody", [
                          ...
                          _c("tr", [
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_request_period")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm._f("moment")(_vm.leave_request.start_date)
                                ) +
                                  " " +
                                  _vm._s(_vm.trans("general.to")) +
                                  " " +
                                  _vm._s(
                                    _vm._f("moment")(_vm.leave_request.end_date)
                                  )
                              )
                            ])
                          ]),
                          ...
                          _c("tr", [
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_request_count")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(
                                "\n\t\t\t\t\t\t\t\t\t\t\t\t" +
                                  _vm._s(
                                    _vm.getLeaveRequestCount(_vm.leave_request)
                                  ) +
                                  "\n\t\t\t\t\t\t\t\t\t\t\t"
                              )
                            ])
                          ...
                          _c("tr", [
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_request_status")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            _c(
                              "td",
                              _vm._l(
                                _vm.getLeaveRequestStatus(_vm.leave_request),
                                function(status) {
                                  return _c(
                                    "span",
                                    {
                          ...
                          _c("tr", [
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_request_reason")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(_vm.leave_request.reason))])
                          ]),
                          _vm._v(" "),
                          _c("tr", [
                            _c("td", [
                              _vm._v(
                                _vm._s(_vm.trans("employee.leave_requested_by"))
                              )
                            ]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(
                                "\n\t\t\t\t\t\t\t\t\t\t\t\t" +
                                  _vm._s(
                                    _vm.getEmployeeName(
                                      _vm.leave_request.requester_user.employee
                                    ) +
                                      " (" +
                                      _vm.getEmployeeCode(
                                        _vm.leave_request.requester_user
                                          .employee
                                      ) +
                                      ")"
                                  ) +
                  ...
                  _vm.attachments.length
                    ? _c("div", { staticClass: "p-2 font-80pc" }, [
                        _c(
                          "ul",
                      ...
                      [
                        _c(
                          ...
                          [
                            _c("tr", [
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm.trans(
                                      "employee.leave_allocation_period"
                                    )
                                  )
                                )
                              ]),
                              ...
                              _c("td", [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("moment")(
                                      _vm.leave_allocation.start_date
                                    )
                                  ) +
                                    " " +
                                    _vm._s(_vm.trans("general.to")) +
                            ...
                            _vm._v(" "),
                            _vm._l(
                              _vm.leave_allocation.leave_allocation_details,
                              function(leave_allocation_detail) {
                                return _c("tr", [
                                  ...
                                  _c("td", [
                                    _vm._v(
                                      _vm._s(leave_allocation_detail.used) +
                                        "/" +
                                        _vm._s(leave_allocation_detail.allotted)
                                    )
                                  ])
                                ])
                              }
            ...
            _c("div", { staticClass: "col-12 col-sm-6" }, [
              _c("div", { staticClass: "card" }, [
                _c(
                  ...
                  [
                    _vm.hasPermission("take-action-on-leave-request")
                      ? [
                          _c(
                            "form",
                            {
                              on: {
                                ...
                                keydown: function($event) {
                                  return _vm.leaveRequestDetailForm.errors.clear(
                                    $event.target.name
                                  )
                                }
                              }
                                          ...
                                          directives: [
                                            {
                                              ...
                                              rawName: "v-model",
                                              value:
                                                _vm.leaveRequestDetailForm
                                                  .status,
                                              expression:
                                                "leaveRequestDetailForm.status"
                                            }
                                          ],
                                    ...
                                    [
                                      _c("label", { attrs: { for: "" } }, [
                                        _vm._v(
                                          _vm._s(
                                            _vm.trans(
                                              "employee.leave_request_comment"
                                            )
                                          )
                                        )
                                      ]),
                                      ...
                                      _c("autosize-textarea", {
                                        ...
                                        model: {
                                          value:
                                            _vm.leaveRequestDetailForm.comment,
                                          callback: function($$v) {
                                            _vm.$set(
                                              _vm.leaveRequestDetailForm,
                                              "comment",
                                          ...
                                          expression:
                                            "leaveRequestDetailForm.comment"
                                        }
                                      }),
                                      _vm._v(" "),
                                      _c("show-error", {
                    ...
                    _c("div", { staticClass: "table-responsive" }, [
                      _c("table", { staticClass: "table table-sm" }, [
                        _c("thead", [
                          _c("tr", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_request_comment")
                                )
                              )
                            ]),
                            _vm._v(" "),
                            _c("th", [
                              _vm._v(
                                _vm._s(
                                  _vm.trans("employee.leave_status_updated_by")
                                )
                              )
                            ]),
                            _vm._v(" "),
                        ...
                        _c(
                          "tbody",
                          _vm._l(
                            _vm.leave_request.leave_request_details,
                              ...
                              return _c("tr", [
                                _c("td", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.trans(
                                        "employee.leave_request_status_" +
                                          leave_request_detail.status
                                      )
                                    )
                                  )
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  _vm._v(_vm._s(leave_request_detail.comment))
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.getEmployeeNameWithCode(
                                        leave_request_detail.approver_user
                                          .employee
                                      )
                                    )
                                  )
                                ...
                                _c("td", [
                                  _vm._v(
                                    _vm._s(
                                      _vm._f("momentDateTime")(
                                        leave_request_detail.updated_at
                                      )
                                    )
                                  )
                                ])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_46b23aa7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./show.vue?vue&type=template&id=46b23aa7& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/employee/leave/request/show.vue?vue&type=template&id=46b23aa7&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_46b23aa7___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_show_vue_vue_type_template_id_46b23aa7___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=show.js.map?id=82a5aa1c505aef40f62c