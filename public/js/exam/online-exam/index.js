...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/exam/online-exam/index.vue?vue&type=template&id=491ef26b&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/exam/online-exam/index.vue?vue&type=template&id=491ef26b& ***!
  \********************************************************************************************************************************************************************************************************************/
        ...
        _c("div", { staticClass: "row" }, [
          ...
          _c("div", { staticClass: "col-12 col-sm-6" }, [
            _c(
              ...
              [
                _vm.online_exams.total &&
                _vm.hasPermission("create-online-exam")
                  ? _c(
                      "button",
                      {
                        directives: [
                      ...
                      _c("table", { staticClass: "table table-sm" }, [
                        _c("thead", [
                          _c("tr", [
                            ...
                            _c("th", [
                              _vm._v(
                                _vm._s(_vm.trans("exam.online_exam_max_mark"))
                              )
                            ]),
                            _vm._v(" "),
                            _vm.hasNotAnyRole(["student", "parent"])
                              ? _c("th", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.trans("exam.online_exam_is_published")
                                    )
                                  )
                                ])
                              : _vm._e(),
                            _vm._v(" "),
                            _vm.hasAnyRole(["student", "parent"])
                              ? _c("th", [
                                  _vm._v(
                                    _vm._s(_vm.trans("exam.online_exam_status"))
                                  )
                                ])
                              : _vm._e(),
                            _vm._v(" "),
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.online_exams.data, function(online_exam) {
                            return _c("tr", [
                              _c("td", {
                                domProps: {
                              ...
                              _c("td", {
                                domProps: {
                                  textContent: _vm._s(
                                    online_exam.batch.course.name +
                                      " " +
                                      online_exam.batch.name
                                  )
                                }
                              }),
                              _vm._v(" "),
                              ...
                              _c("td", [
                                _vm._v(
                                  "\n                                    " +
                                    ...
                                    "\n                                    " +
                                    _vm._s(
                                      _vm._f("momentTime")(online_exam.end_time)
                                    ) +
                                    "\n                                "
                                )
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(_vm._s(online_exam.questions_count))
                              ]),
                              _vm._v(" "),
                              _c("td", [_vm._v(_vm._s(online_exam.max_mark))]),
                              _vm._v(" "),
                              _vm.hasNotAnyRole(["student", "parent"])
                                ? _c("td", [
                                    online_exam.is_published
                                      ? _c("span", [
                                          _c("i", {
                                    ...
                                    _c(
                                      "span",
                                      {
                                        class: [
                                          "label",
                                          "label-" +
                                            online_exam.status_detail.type
                                        ]
                                      },
                                      [
                                        _vm._v(
                                          _vm._s(online_exam.status_detail.text)
                                        )
                                      ]
                                    )
                                  ])
                              ...
                              _c("td", { staticClass: "table-option" }, [
                                _c(
                                  ...
                                  [
                                    _vm.hasPermission("edit-online-exam")
                                      ? _c(
                                          "router-link",
                                          {
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-tooltip",
                                                value: _vm.trans(
                                                  "exam.manage_online_exam_questions"
                                                ),
                                                expression:
                                                  "trans('exam.manage_online_exam_questions')"
                                              }
                                            ],
                                            staticClass:
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    _vm.hasAnyRole(["student"]) &&
                                    online_exam.status != "upcoming"
                                      ? _c(
                                          "router-link",
                                          {
                                            directives: [
                                    ...
                                    online_exam.is_editable
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-tooltip",
                                                value: _vm.trans(
                                                  "exam.edit_online_exam"
                                                ),
                                                expression:
                                                  "trans('exam.edit_online_exam')"
                                              }
                                            ],
                                            staticClass: "btn btn-info btn-sm",
                                            on: {
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    _vm.hasPermission("delete-online-exam") &&
                                    online_exam.is_editable
                                      ? _c(
                                          "button",
                                          {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_491ef26b___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=491ef26b& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/exam/online-exam/index.vue?vue&type=template&id=491ef26b&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_491ef26b___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_491ef26b___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=index.js.map?id=245ed8963beb85eb7bd8