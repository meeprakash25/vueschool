...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/student/fee/set.vue?vue&type=template&id=6abf1f56&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/student/fee/set.vue?vue&type=template&id=6abf1f56& ***!
  \*************************************************************************************************************************************************************************************************************/
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm._v(
                          " " + _vm._s(_vm.trans("finance.view_fee_allocation"))
                        )
                      ]
                    )
                  ]
            ...
            "form",
            {
              on: {
                ...
                keydown: function($event) {
                  return _vm.studentFeeRecordForm.errors.clear(
                    $event.target.name
                  )
                }
              }
              ...
              _vm._l(_vm.studentFeeRecordForm.fee_groups, function(fee_group) {
                return [
                  _c("h4", { staticClass: "card-title" }, [
                    _vm._v(_vm._s(fee_group.name))
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "row m-b-20" }, [
                    _c("div", { staticClass: "col-12 col-sm-2 text-strong" }, [
                      _vm._v(
                        "\n                                " +
                    ...
                    _c("div", { staticClass: "col-12 col-sm-2 text-strong" }, [
                      _vm._v(
                        "\n                                " +
                          _vm._s(
                            _vm.trans("finance.fee_installment_due_date")
                          ) +
                          "\n                            "
                      )
                    ]),
                  ...
                  _vm._v(" "),
                  _vm._l(fee_group.installments, function(installment) {
                    return [
                      _c("div", { staticClass: "row" }, [
                        _c("div", { staticClass: "col-12 col-sm-2" }, [
                          _vm._v(
                            "\n                                    " +
                              _vm._s(installment.title) +
                              " "
                          ),
                          _c("br"),
                          _vm.isInstallmentOverdue(installment)
                            ? _c(
                                "span",
                                { staticClass: "label label-danger" },
                                [
                                  _vm._v(
                                    _vm._s(_vm.trans("finance.fee_overdue"))
                                  )
                                ]
                              )
                            : _vm._e()
                            ...
                            [
                              _c("datepicker", {
                                ...
                                on: {
                                  selected: function($event) {
                                    _vm.studentFeeRecordForm.errors.clear(
                                      _vm.getDueDateFieldName(installment)
                                    )
                                  }
                                },
                                model: {
                              ...
                              _c("show-error", {
                                attrs: {
                                  ...
                                  "prop-name": _vm.getDueDateFieldName(
                                    installment
                                  )
                                }
                              })
                        ...
                        _c("div", { staticClass: "col-12 col-sm-2" }, [
                          installment.status == "paid"
                            ? _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.trans("student.fee_status_paid"))
                                  )
                                ]
                              )
                            : _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.trans("student.fee_status_unpaid")
                                    )
                                  )
                                ]
                              )
                                ...
                                [
                                  _c(
                                    "select",
                                    {
                                      ...
                                      attrs: {
                                        name: _vm.getTransportFieldName(
                                          installment
                                        ),
                                        disabled: installment.status != "unpaid"
                                      },
                                  ...
                                  _c("show-error", {
                                    attrs: {
                                      "form-name": _vm.studentFeeRecordForm,
                                      "prop-name": _vm.getTransportFieldName(
                                        installment
                                      )
                                    }
                                  })
                          ...
                          _c(
                            ...
                            [
                              _c(
                                  ...
                                  directives: [
                                    {
                                      ...
                                      expression:
                                        "installment.fee_concession_id"
                                    }
                                  ],
                                  staticClass: "custom-select col-12",
                                  attrs: {
                                    name: _vm.getFeeConcessionFieldName(
                                      installment
                                    ),
                                    disabled: installment.status != "unpaid"
                                  },
                                ...
                                [
                                  _c("option", { domProps: { value: null } }, [
                                    _vm._v(
                                      _vm._s(
                                        _vm.trans("finance.no_fee_concession")
                                      )
                                    )
                                  ]),
                                  _vm._v(" "),
                              ...
                              _c("show-error", {
                                attrs: {
                                  "form-name": _vm.studentFeeRecordForm,
                                  "prop-name": _vm.getFeeConcessionFieldName(
                                    installment
                                  )
                                }
                              })
                                  ...
                                  _c(
                                      ...
                                      directives: [
                                        {
                                          ...
                                          value: fee_head.value
                                            ? _vm.trans(
                                                "finance.uncheck_to_make_it_optional"
                                              )
                                            : _vm.trans(
                                                "finance.check_to_make_it_mandatory"
                                              ),
                                          expression:
                                            "fee_head.value ? trans('finance.uncheck_to_make_it_optional') : trans('finance.check_to_make_it_mandatory')"
                                        }
                                      ],
                                      staticClass:
                                    ...
                                    [
                                      _c("input", {
                                        ...
                                        domProps: {
                                          checked: Array.isArray(fee_head.value)
                                            ? _vm._i(fee_head.value, "1") > -1
                                            : fee_head.value
                                        },
                                        on: {
                                ...
                                [
                                  _c(
                                    "select",
                                    {
                                      ...
                                      staticClass: "custom-select col-12",
                                      attrs: {
                                        name: _vm.getLateFeeFrequencyFieldName(
                                          installment
                                        ),
                                        disabled: installment.status != "unpaid"
                                      },
                                  ...
                                  _c("show-error", {
                                    attrs: {
                                      "form-name": _vm.studentFeeRecordForm,
                                      "prop-name": _vm.getLateFeeFrequencyFieldName(
                                        installment
                                      )
                                    }
                                  })
                            ...
                            ? _c(
                                ...
                                [
                                  _c("input", {
                                    ...
                                    domProps: { value: installment.late_fee },
                                    on: {
                                  ...
                                  _c("show-error", {
                                    attrs: {
                                      "form-name": _vm.studentFeeRecordForm,
                                      "prop-name": _vm.getLateFeeFieldName(
                                        installment
                                      )
                                    }
                                  })
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c("show-error", {
                                attrs: {
                                  "form-name": _vm.studentFeeRecordForm,
                                  "prop-name": _vm.getRemarkFieldName(
                                    installment
                                  )
                                }
                              })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_set_vue_vue_type_template_id_6abf1f56___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./set.vue?vue&type=template&id=6abf1f56& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/student/fee/set.vue?vue&type=template&id=6abf1f56&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_set_vue_vue_type_template_id_6abf1f56___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_set_vue_vue_type_template_id_6abf1f56___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=set.js.map?id=099839b52469b5d1e2f2