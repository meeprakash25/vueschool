  ...
  methods: {
    ...
    get: function get() {
      ...
      axios.get('/api/frontend/block/' + this.uuid).then(function (response) {
        ...
        _this3.blockForm.block_type = response.block.block_type;
            ...
            _c("div", { staticClass: "form-group" }, [
              _c("div", { staticClass: "form-check form-check-inline" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.blockForm.block_type,
                      expression: "blockForm.block_type"
                    }
                  ],
                  ...
                  domProps: {
                    checked: _vm._q(_vm.blockForm.block_type, "program")
                  },
                  on: {
                    change: function($event) {
                      return _vm.$set(_vm.blockForm, "block_type", "program")
                    }
                  }
                }),
                _vm._v(" "),
              ...
              _c("div", { staticClass: "form-check form-check-inline" }, [
                _c("input", {
                  ...
                  domProps: {
                    checked: _vm._q(_vm.blockForm.block_type, "feature")
                  },
                  on: {
                    change: function($event) {
                      return _vm.$set(_vm.blockForm, "block_type", "feature")
                    }
                  }
                }),
                _vm._v(" "),
...
//# sourceMappingURL=index.js.map?id=882e5cba179c8f981cd3