...
class UploadController extends Controller
{
    ...
    public function upload()
    {
        ...
        //request()->file('file')->store('uploads/' . $module);
        \Storage::disk('public')->putFile('uploads/'.$module, request()->file('file'));
        $upload->filename = $upload->filename = request()->file('file')->store('uploads/'.$module);
