...
class FrontendController extends Controller {
	...
	public function getContent($slug) {
        ...
        $blocks = ($page->getOption('show_blocks')) ? $this->repo->listBlocks('program') : [];

        $features = ($page->getOption('show_blocks')) ? $this->repo->listBlocks('feature') : [];
        ...
        return $this->success(compact('page', 'attachments', 'events', 'blocks', 'articles', 'features'));
    }
	 ...
	 * Used to list Articles for frontend
	 */
	public function listArticleNotices() {
		$articles = $this->repo->paginateArticle($this->request->all());
